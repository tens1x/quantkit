...
| v0.2 | CLI UX: prompt_toolkit 补全 + 视觉统一 | ✅ | 2026-04-06 |
| v0.2 | 全项目 review + 修复 (H1-H3, M1/M3/M4, L1-L4) | ✅ | 2026-04-06 |
| research | 论文: Intramonth Momentum Cycle | ✅ | 2026-04-06 |
| research | 策略: PreTOM 日历仓位缩放 (PineScript) | ✅ | 2026-04-06 |
| research | 策略: G1 Dual Engine 融合策略 (PineScript) | ✅ | 2026-04-06 |
...
| # | 功能 | 来源 | 状态 |
|---|------|------|------|
| 1 | 验证 PreTOM 效应在港股/A 股是否存在 | 论文研究 | 待数据验证 |
| 2 | Low PE 策略实现（需要历史 PE 时间序列数据） | 设计 spec | 待研究数据来源 |
| 3 | 买卖净额化（IBKR 导入计算真实持仓而非只看买单） | 用户反馈 | 待实现 |
| 4 | 月内动量日历因子（基于 PreTOM 论文）| 论文研究 | 待验证后决定 |
| 5 | 知行线 (ZXDKX) 作为替代 Regime Filter 测试 | StockTradebyZ 分析 | 待评估 |
